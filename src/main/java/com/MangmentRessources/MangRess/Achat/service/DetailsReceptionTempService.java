...
import com.MangmentRessources.MangRess.Achat.repository.DetailsReceptionRepo;
...
public class DetailsReceptionTempService {
    ...
    private final DetailsReceptionRepo detailsReceptionRepo;

    public DetailsReceptionTempService(DetailsReceptionRepo detailsReceptionRepo) {
