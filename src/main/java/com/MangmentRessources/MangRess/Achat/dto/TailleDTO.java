...
public class TailleDTO {
    ...
    private GrilleTailleDTO grilleTailleDTO;
    ...
    public GrilleTailleDTO getGrilleTailleDTO() {
        return grilleTailleDTO;
    }

    public void setGrilleTailleDTO(GrilleTailleDTO grilleTailleDTO) {
        this.grilleTailleDTO = grilleTailleDTO;
    }
